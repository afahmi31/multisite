...
@section('content')
    <div class="flex-1">
        <div class="p-[32px] border-b-1 border-[#EFEFEF] flex justify-between items-center">
            <h1 class="text-primary">Dashboard</h1>
            <div class="flex items-center gap-2">
                <div class="flex items-center gap-2 rounded-full border border-gray-300 px-4 py-2">
                    <input type="text" name="" id="" placeholder="Search..." class="border-none" />
                ...
                <button class="rounded-full w-[40px] h-[40px] bg-[#EFEFEF] flex items-center justify-center">
                ...
                <div class="rounded-full w-[40px] h-[40px] bg-[#919191] flex items-center justify-center"></div>
            </div>
        </div>
        <div class="flex items-center justify-between pt-[32px] px-[32px]">
            <h2 class="text-black font-semibold text-base">Recent Project</h2>
            <button class="bg-black rounded-lg text-white px-4 py-2 flex items-center gap-2 start-new-project">
                <span> Start New Project </span>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.00001 3.33337V12.6667M3.33334 8.00004H12.6667" stroke="#F5F5F5" stroke-width="1.6"
        ...
        <div class="w-full flex justify-center items-center h-[calc(100vh-200px)] list-website">
            <div class="flex justify-center items-center flex-col gap-2">
                <p>You didn’t have any project</p>
                <button id="start-new-project" class="bg-black rounded-lg text-white px-4 py-2 flex items-center gap-2">
                    <span> Start New Project </span>
                </button>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg max-w-[763px] w-full relative z-10">
            <div class="flex justify-between items-center border-b-1 border-[#EFEFEF] p-6">
                ...
                <button id="close-modal" class="p-1">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 6L6 18M6 6L18 18" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round"
            ...
            <form class="flex flex-col gap-4 p-6 website-form">
                <div class="flex flex-col gap-2">
                    <label for="organization-name" class="font-medium">Organization Name</label>
                    <input type="text" id="organization-name" name="organization_name"
                        class="border border-gray-300 rounded-lg p-2" placeholder="Enter project name" />
                </div>
                <div class="flex flex-col gap-2">
                    <label for="project-description" class="font-medium">Description</label>
                    <textarea id="project-description" class="border border-gray-300 rounded-lg p-3" rows="3" name="description"
                        placeholder="Enter project description"></textarea>
                </div>
                <div class="flex flex-col gap-2">
                    <label for="site-name" class="font-medium">Site name</label>
                    <input type="text" id="site-name" name="site_name" class="border border-gray-300 rounded-lg p-2" autocomplete="off"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="site-title" name="site_title"
                        class="border border-gray-300 rounded-lg p-2" placeholder="Enter your site ttile" autocomplete="off"/>
                </div>
                <div class="flex flex-col gap-2">
                    <label for="site-template" class="font-medium">Choose Template</label>
                    <select id="site-template" name="site_template" class="border border-gray-300 rounded-lg p-2">
                        <option value="">Choose Template</option>
                    </select>
                </div>
                <div class="flex justify-between items-center">
                    <button class="bg-[#E3E3E3] text-black py-1 px-2 rounded-lg mt-2 border border-black">
                        Back
                    </button>
                    <button type="submit" id="next" class="bg-black text-white py-1 px-2 rounded-lg mt-2">
                        Next
                    </button>
                </div>
            </form>
